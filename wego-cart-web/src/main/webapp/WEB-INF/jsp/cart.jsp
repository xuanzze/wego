...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://localhost:8082"><img clstag="clickcart|keycount|xincart|logo" src="/images/wego-logo.png" title="返回微购商城首页" alt="返回微购商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">微购价</div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去微购国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去微购结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
